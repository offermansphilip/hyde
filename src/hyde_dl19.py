...
# Evaluation commands
os.system('python -m pyserini.eval.trec_eval -c -l 2 -m map dl19-passage hyde-dl19-contriever-gpt3-top1000-8rep-trec')
os.system('python -m pyserini.eval.trec_eval -c -m ndcg_cut.10 dl19-passage hyde-dl19-contriever-gpt3-top1000-8rep-trec')
os.system('python -m pyserini.eval.trec_eval -c -l 2 -m recall.1000 dl19-passage hyde-dl19-contriever-gpt3-top1000-8rep-trec')